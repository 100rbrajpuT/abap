...
TYPES: BEGIN OF zheader_data,
         name1     TYPE ad_name1,
         name2     TYPE ad_name2,
         full_name TYPE char40,
         zbukr     TYPE dzbukr,
         hbkid     TYPE hbkid,
         ubnky     TYPE ubnky,
         ubknt     TYPE ubknt,
...
DATA: it_item TYPE TABLE OF zitem_data,
      wa_item TYPE zitem_data.


DATA: it_header TYPE TABLE OF zheader_data,
      wa_header TYPE zheader_data.

DATA: it_bill TYPE TABLE OF zbill_dt,
      wa_bill TYPE zbill_dt.
