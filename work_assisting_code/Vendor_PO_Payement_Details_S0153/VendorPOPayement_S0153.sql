...
+ @chr +'	WHERE  '
+ @chr +'			B.KTOSL=''WIT'' '
+ @chr +' GROUP BY B.BUKRS,B.BELNR,B.GJAHR)MN ON K.COMPANYCODE=MN.BUKRS AND K.INVOICEFISCALYEAR=MN.GJAHR AND K.FIINVOICENO=MN.BELNR '
